...
const state = {
  ...
  totalWorkRounds: 0,
  tickSounds: localStore.get('tickSounds') === undefined ? true : localStore.get('tickSounds'),
  tickSoundsDuringBreak: localStore.get('tickSoundsDuringBreak') === undefined ? true : localStore.get('tickSoundsDuringBreak'),
